...
def feedback_to_dict(row: LandingFeedbackSubmission) -> dict:
    return {
        ...
        "rating": row.rating,
        "algorithm_clarity": row.algorithm_clarity,
        "most_useful_signal": row.most_useful_signal,
        "trust_for_decisions": row.trust_for_decisions,
...
async def create_landing_feedback(
    ...
    *,
    ...
    rating: Optional[int],
    algorithm_clarity: Optional[str],
    most_useful_signal: Optional[str],
    trust_for_decisions: Optional[str],
    suggestion: str,
    ...
    row = LandingFeedbackSubmission(
        ...
        rating=rating,
        algorithm_clarity=(algorithm_clarity or "").strip() or None,
        most_useful_signal=(most_useful_signal or "").strip() or None,
        trust_for_decisions=(trust_for_decisions or "").strip() or None,
    ...
    if search:
        ...
        stmt = stmt.where(
            or_(
                ...
                func.lower(func.coalesce(LandingFeedbackSubmission.algorithm_clarity, "")).like(q),
                func.lower(func.coalesce(LandingFeedbackSubmission.most_useful_signal, "")).like(q),
                func.lower(func.coalesce(LandingFeedbackSubmission.trust_for_decisions, "")).like(q),
